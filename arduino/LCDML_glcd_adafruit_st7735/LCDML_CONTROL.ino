...
// *********************************************************************
	...
	#define _LCDML_CONTROL_digitalread 3 //don't work with u8glib
...
{ 
  ...
  unsigned int startX = analogRead(_LCDML_CONTROL_analog_pinx);
  unsigned int startY = analogRead(_LCDML_CONTROL_analog_piny);
  // Arduino Uno Pins A0 for SWX, A1 for SWY and D3 for SW
  joystick = PS2Joystick(_LCDML_CONTROL_analog_pinx, _LCDML_CONTROL_analog_piny,
    _LCDML_CONTROL_digitalread, startX, startY); // initialize an instance of the class
}
// *********************************************************************
// loop
void LCDML_CONTROL_loop()
